...
def generate_swagger_json(app):
    ...
    for k, v in app.endpoint_resource.items():
        cls_path_dict = dict()
        if v.__class__.__name__ == "SmartResource":
            pass
            # if v.ResourceCls.__doc__:
            #     tag_description = v.ResourceCls.__doc__
            # else:
            #     tag_description = ''
            # tag_externalDocs_description = f'AutoApi From [Model]{v.ResourceCls.__name__}'
            # load_dict["tags"].append({
            #     "name": app.endpoint_url[k],
            #     "description": tag_description,
            #     "externalDocs": {
            #         'description': tag_externalDocs_description
            #     }
            # })
            # # if hasattr(v, 'get'):
            # if "get" in v.allowed_methods:
            #     # get moodle attr  / all attr go to url
            #
            #     cls_path_dict["get"] = {}
            ...
            #     get_params = v.ModelSerializer.Meta.fields
            #     for param in list(filter(lambda x: x not in exclude_params, get_params)):
            #         param_dict = dict()
            ...
            #     cls_path_dict["put"]["parameters"] = [{"name": "boby", "in": "body", "description": ""}]
            ...
            #     delete_params = v.ModelSerializer.Meta.fields
            #     for param in list(filter(lambda x: x not in exclude_params, delete_params)):
            #         param_dict = dict()
            #         param_dict['name'] = param
            #         param_dict['in'] = "query"
            #         param_dict['description'] = ""
